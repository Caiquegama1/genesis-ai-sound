...
const Step11ProInstrumentFormats: React.FC<StepProps> = ({ formData, updateForm, t }) => {
    
    if (formData.mode !== 'Pro') {
        return (
             <StepWrapper title={t('step.pro_formats')} stepKey={11}>
    ...
    return (
        <StepWrapper title={t('pro_formats.title')} stepKey={11}>
...
export default Step11ProInstrumentFormats;
